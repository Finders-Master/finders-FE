  ...
  <>
    ...
    <section className="Home">
      <article className="Home__description">
        <img src={Iphone} alt="telefono movil con la pantalla escaneando un codigo qr FindMe" 
        ...
        <div className="Home__description__text">
          <h2>
            ...
            para atender una urgencia en
            personas con enfermedades degenerativas
            como aizhaimer entre otras enfermedades
          </h2>
          <img
            src={GivingCard}
      ...
      <article className="Home__instrucctions">
        <div className="Home__instrucctions__container">
          <div>
            <h3>¿COMO FUNCIONA?</h3>
            <h4>Si encuentras a alguien con complicaciones seguramente esta inscrito en FINDME</h4>
          </div>
          <div className="Home__instrucctions__container__icons">
            <div>
              <img src={ScaningIstrucction} alt="instrucciones icono de pantalla escaneando un qr" />
              <p>Localiza la tarjeta con el codigo QR</p>
            </div>
            <div>
              <img src={HandMobile} alt="instrucciones icono de pantalla escaneando un qr" />
              <p>Escanealo con la camara de tu celular o aquí</p>
            </div>
            <div>
              <img src={IconCard} alt="instrucciones icono de pantalla escaneando un qr" />
              <p>
                serás enviado a una página
                con los datos personales de
                la persona asi como indicacones
                para su auxilio
              </p>
            </div>
            <div>
              <img src={IconLocation} alt="instrucciones icono de pantalla escaneando un qr" />
              <p>
                La aplicación
                mandara la ubicación
                de la persona a su
                guardian
              </p>
            </div>
      ...
      <article className="Home__helpus">
        <div className="Home__helpus__container">
          <img src={IconHearth} alt="icono de un corazon pixeleado, parte del logo de findme"
            className="animate__animated animate__heartBeat animate__infinite"
          />
          <h2>AYUDANOS A SALVAR VIDAS</h2>
          <h4>
            RESGISTRATE COMO GUARDIAN Y
            DA DE ALTA A UN CONOCIDO O FAMILIAR TUYO,
            UN DÍA PUEDE NECESITAR TU AYUDA Y
            SABRAS DONDE ENCONTRARLO
          </h4>
        </div>
      </article>
    </section>
